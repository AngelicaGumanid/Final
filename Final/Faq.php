...
<!-- Navigation Bar -->
	...
	<div class="sidenav">
		...
		<b>
			<a href="<?php echo 'About.php'; ?>"> About TAC</a><br>
			<a href="<?php echo 'Shopinfo.php'; ?>"> Shop Information </a><br>
			<a href="<?php echo 'Accsafety.php'; ?>"> Account and Safety </a><br>
			<a href="<?php echo 'Orderandpay.php'; ?>"> Orders and Payment </a><br>
			<a href="<?php echo 'Shipanddelivery.php'; ?>"> Shipping and Delivery </a><br>
			<a href="<?php echo 'Returnandrefunds.php'; ?>"> Returns and Refunds </a><br>
		</b>
