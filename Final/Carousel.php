...
<header>
 ...
 <div id="main">
  <div>
   <a class="navbar-brand" href="#"><img src="images/wlogo.png" width="100px" height="80px"></a>
   </div>
  <div>
<form class="form-inline my-2 my-sm-0">
  ...
  <a  href="#" style="color: #FFFFFF;"> <button class="btn"> Sign Up </a></button>
  </div>
</div>
...
<!-- Navigation Bar -->
  <nav class="navbar navbar-expand-lg navbar-light navbar-custom sticky-top">
      <a class="navbar-brand" href="#">TORI ANIME COLLECTIBLES</a>
...
<div class="row"> 
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img style = "height: 417px" class="d-block w-100" src="images/works/1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img style = "height: 417px" class="d-block w-100" src="images/works/2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img style = "height: 417px" class="d-block w-100" src="images/works/3.jpg" alt="Third slide">
    </div>
  </div>
  <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
  ...
  <div class="column">
  <div class='box'>
<img src="images/wlogo.png" alt="profile" border="0" alt="" class="box-img">
<a class="box-link" href="#">PREORDER</a>
    </div>
...
<div class='box'>
<img src="images/wlogo.png" alt="profile" border="0" alt="" class="box-img">
<a class="box-link" href="#">ACCESSORIES</a>
    </div>
  </div>  
  ...
  <div class='box'>
<img src="images/wlogo.png" alt="profile" border="0" alt="" class="box-img">
<a class="box-link" href="#">SHOP BY SERIES</a>
    </div>
...
<div class='box'>
<img src="images/wlogo.png" alt="profile" border="0" alt="" class="box-img">
<a class="box-link" href="#">UNDER P00.00</a>
    </div>
  </div>
  ...
  <div class='box'>
<img src="images/wlogo.png" alt="profile" border="0" alt="" class="box-img">
<a class="box-link" href="#">FIGURE LINE</a>
    </div>
...
<div class='box'>
<img src="images/wlogo.png" alt="profile" border="0" alt="" class="box-img">
<a class="box-link" href="#">TORI MERCH</a>
    </div>
  </div>
</div>
...
<footer>
  ...
  <div class="container first_class">
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          <ul class="footer-links">
            <a href="#">| Home</a><br>
	<a href="#">| Shop</a><br>
	<a style= "margin-left: 50px;" href="#">Site Map</a><br>
	<a style= "margin-left: 50px;" href="#">Categories</a><br>
	<a style= "margin-left: 50px;" href="#">Terms and Service</a><br>
	<a style= "margin-left: 50px;" href="#">Privacy Policies</a><br>
	<a style= "margin-left: 50px;" href="#">Help Center</a><br>
	<a href="#">| About</a><br>
	<a href="#">| Tori Merch</a><br>
	<a href="#">| News and Updates</a><br>
          </ul>
        </div>
	...
	<div class="logo2">
<img src="images/wlogo.png" alt="logo">	</div>
	<p> Distributor Name </p>
	<p> Address </p>
	<div class="logo2"> <img src="images/wlogo.png" alt="logo"></div>
	<p> Distributor Name </p>
	<p> Address </p>
