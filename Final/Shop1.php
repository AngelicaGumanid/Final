...
<div class="wrapper">
	...
	<div class="row">
		...
		<div class="card">
			...
			<div class="cardimage"><img src="images/product/13.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="card">
			...
			<div class="cardimage"><img src="images/product/14.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="card">
			...
			<div class="cardimage"><img src="images/product/15.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="card">
			...
			<div class="cardimage"><img src="images/product/16.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
	...
	<div class="row">
		...
		<div class="cardimage"><img src="images/product/17.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="cardimage"><img src="images/product/9 (2).png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="cardimage"><img src="images/product/21.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="cardimage"><img src="images/product/22.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
	...
	<div class="row">
		...
		<div class="cardimage"><img src="images/product/23.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="cardimage"><img src="images/product/24.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="cardimage"><img src="images/product/25.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="cardimage"><img src="images/product/26.png" alt=""></div>
			<p>Some text</p>
			<p>Soe text</p>
