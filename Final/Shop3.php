...
<div class="wrapper">
	...
	<div class="row">
		...
		<div class="card">
			...
			<div class="cardimage"><img src="images/product/39.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
		...
		<div class="card">
			...
			<div class="cardimage"><img src="images/product/40.png" alt=""></div>
			<p>Some text</p>
			<p>Some text</p>
	...
	<div class="pagination"style="margin-left: 200px;">
		...
		<a href="<?php echo 'Shop2.php'; ?>"><i class="fas fa-chevron-left"></i></a>
		<a href="<?php echo 'Shop1.php'; ?>">1</a>
		<a href="<?php echo 'Shop2.php'; ?>">2</a>
		<a href="<?php echo 'Shop3.php'; ?>"style="color:#eb4d4b;">3</a>
