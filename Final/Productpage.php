  ...
  <div class="container">
        ...
        <div class="single_product">
          <div class="container-fluid" style=" background-color: #fff; padding: 11px;">
            <div class="row">
              <div class="col-md-6">
                <div class="image_selected" style =  >
                  <img src="images/product/1.png" alt="" style="width:100%; height:100%; object-fit:contain;" >
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class = "container">
                  ...
                  <center>
                    <button class="btnto ">All</button>
                    <button class="btnto ">5 Stars</button>
                    <button class="btnto ">4 Stars</button>
                    <button class="btnto ">3 Stars</button>
                    <button class="btnto ">2 Stars</button>
                    <button class="btnto ">1 Stars</button>
                    <button class="btnto ">No Rating</button>
                  </center>
            </div>
        </div>
